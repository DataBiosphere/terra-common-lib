...
//
//    Stairway stairway =
//        StairwayTestUtils.setupStairway(new StairwayBuilder().stairwayHook(new
// MonitoringHook(openTelemetry)));
...
//    long errorCount = getCurrentCount(FLIGHT_ERROR_METER_NAME, ERROR_COUNT_TAGS);
//
//    Stairway stairway =
//        StairwayTestUtils.setupStairway(new StairwayBuilder().stairwayHook(new
// MonitoringHook(openTelemetry)));
...
//    assertEquals(FlightStatus.SUCCESS, flightState.getFlightStatus());
//    sleepForSpansExport();
//    assertCountIncremented(FLIGHT_ERROR_METER_NAME, ERROR_COUNT_TAGS, errorCount, 0);
//  }
//
//  @Test
...
//    assertEquals(FlightStatus.ERROR, flightState.getFlightStatus());
//    sleepForSpansExport();
//    assertCountIncremented(FLIGHT_ERROR_METER_NAME, ERROR_COUNT_TAGS, errorCount, 1);
//  }
//
//  @Test

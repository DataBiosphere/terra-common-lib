...
public class LiquibaseMigrator {
  ...
  public void initialize(String changesetFile, DataSource dataSource) {
    migrateDatabase(changesetFile, dataSource, true);
  }
  ...
  public void upgrade(String changesetFile, DataSource dataSource) {
    migrateDatabase(changesetFile, dataSource, false);
  }

  private void migrateDatabase(String changesetFile, DataSource dataSource, boolean initialize) {

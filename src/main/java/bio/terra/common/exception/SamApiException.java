...
import bio.terra.common.retry.SamRetry;
...
public class SamApiException extends Exception {
  ...
  static public SamApiException createSamApiException(ApiException apiException) {
  ...
  public SamApiException(String message, ApiException apiException) {
  ...
  public HttpStatus getStatusCode() {
    return HttpStatus.resolve(apiException.getCode());
  }
